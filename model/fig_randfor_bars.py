...
if fig_opt == 1:
    ...
    for ff in fs.get_formats():
        fig.savefig('../figures/feat_importances',
                    format=ff,
                    bbox_inches='tight')
    ...
    # Create figure
    fig = plt.figure(dpi=300, figsize=fs.fig_size(0.75,0.45))
    ax_big = fig.add_subplot(111, frameon=False)
    ...
    loc = ['absolute-sum_y_sys_perf','absolute-sum_y_num_cycles']
    df.loc[loc].plot(kind='bar',ax=ax1,legend=False)
    plt.setp(ax1.get_xticklabels(), rotation=rot, horizontalalignment='right')
    ax1.set_xticklabels(outcomes,rotation=rot)
    ...
    loc = ['sphere_y_sys_perf','sphere_y_num_cycles']
    df.loc[loc].plot(kind='bar',ax=ax2,legend=False)
    plt.setp(ax2.get_xticklabels(), rotation=rot, horizontalalignment='right')
    ax2.set_xticklabels(outcomes,rotation=rot)
    ...
    loc = ['ackley_y_sys_perf','ackley_y_num_cycles']
    df.loc[loc].plot(kind='bar',ax=ax3,legend=False)
    plt.setp(ax3.get_xticklabels(), rotation=rot, horizontalalignment='right')
    ax3.set_xticklabels(outcomes,rotation=rot)
    ...
    loc = ['levy_y_sys_perf','levy_y_num_cycles']
    df.loc[loc].plot(kind='bar',ax=ax4,legend=False)
    plt.setp(ax4.get_xticklabels(), rotation=rot, horizontalalignment='right')
    ax4.set_xticklabels(outcomes,rotation=rot)
